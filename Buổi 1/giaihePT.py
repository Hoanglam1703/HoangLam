...
def clear():
    ...
    Button(win, text = 'Create', command = cal.create, font = ('Times new roman', 15), fg = 'black', bg = '', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 280, y = 710)
    Button(win, text = 'Exit', command = exit, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 380, y = 710)
    Button(win, text = 'Clear', command = clear, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 480, y = 710)
    Button(win, text = 'Calculate', command = cal.calculate, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 8, height = 2, relief='solid', borderwidth = 2).place(x = 580, y = 710)

cal = Cal(A, entries_A, B, entries_B)
Button(win, text = 'Create', command = cal.create, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 280, y = 710)
Button(win, text = 'Exit', command = exit, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 380, y = 710)
Button(win, text = 'Clear', command = clear, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 6, height = 2, relief='solid', borderwidth = 2).place(x = 480, y = 710)
Button(win, text = 'Calculate', command = cal.calculate, font = ('Times new roman', 15), fg = 'black', bg = 'lavender', width = 8, height = 2, relief='solid', borderwidth = 2).place(x = 580, y = 710)
